...
dp = obj.calc_density_profile(binl,dmax,mode='mass',option='2side') # returns a dictionary containing the data in arrays
...
plt.xlim([-5,5])
plt.plot(-dp['d'],dp['rho_down'],label=r'$\rho_{down}$',color='green')
plt.plot(dp['d'],dp['rho_up'],label=r'$\rho_{up}$',color='blue')
plt.legend(frameon=False)
plt.savefig('mass_density_2side.png',bbox_inches='tight')
plt.show()