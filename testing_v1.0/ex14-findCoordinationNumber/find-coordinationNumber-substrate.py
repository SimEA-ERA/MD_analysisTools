...
obj = mda.Analysis('../gro/alu.gro','../itp/alu_to.itp')
obj.read_file()
maxdist = 0.2
type1='Alt'
type2='O'
coordination_sub = obj.calc_atomic_coordination(maxdist,type1,type2)
coordination_sub.update(obj.calc_atomic_coordination(0.26,['Alo','Alt'], 'O'))
t = coordination_sub['Alt-O']
o = coordination_sub['Alo_Alt-O']
