...
pd_AltO = results.calc_pair_distribution(binl,dmax,'Alt','O',density='coordination')
...
plt.plot(pd_AltO['d'],pd_AltO['gr'],marker='o',fillstyle='none',label = r'$Alt-O$',color='green')
#plt.plot(pd_all['d'],pd_all['gr'],marker='o',ls='--',lw=0.5,fillstyle='none',label = r'$all-all',color='k')
plt.legend(frameon=False,fontsize=8)
plt.savefig('Alt-O.png',bbox_inches='tight')
plt.show()
