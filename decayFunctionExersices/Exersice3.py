...
for j,A in enumerate(As):
    for i,t0 in enumerate(t0s):
        y = funcs.expDecay3(t,A,t0)
        plt.plot(t,y,ls=lst[i],lw=2,color=colors[j],
         label=r'$t_0$={},A={}'.format(t0,A))
plt.legend(frameon=False,fontsize=size*2.5)
if save_figs:plt.savefig(path +'/expdecay3_onlyA.png',bbox_inches='tight')
plt.show()
